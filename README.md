...
Events are fetched at build time from the [TechMoncton/Meetups](https://github.com/TechMoncton/Meetups) repository. The site rebuilds automatically when events are updated.
